...
namespace DAL
{
    public abstract class _ReceiveDoc : SqlClientEntity
    {
        public _ReceiveDoc()
        {
            this.QuerySource = "ReceiveDoc";
            this.MappingName = "ReceiveDoc";
        ...
        public bool LoadAll()
        {
            ...
            return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_ReceiveDocLoadAll]", parameters);
        }
        ...
        public virtual bool LoadByPrimaryKey(int ID)
        {
            ...
            return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_ReceiveDocLoadByPrimaryKey]", parameters);
        }
        ...
        protected class Parameters
        {
            ...
            public static SqlParameter InternalDrugCode
            {
                get
                {
        ...
        public class ColumnNames
        {
            ...
            static public string ToPropertyName(string columnName)
            {
                if (ht == null)
                {
                    ...
                    ht[ID] = _ReceiveDoc.PropertyNames.ID;
                    ht[BatchNo] = _ReceiveDoc.PropertyNames.BatchNo;
                    ht[ItemID] = _ReceiveDoc.PropertyNames.ItemID;
                    ht[SupplierID] = _ReceiveDoc.PropertyNames.SupplierID;
                    ht[Quantity] = _ReceiveDoc.PropertyNames.Quantity;
                    ht[Date] = _ReceiveDoc.PropertyNames.Date;
                    ht[ExpDate] = _ReceiveDoc.PropertyNames.ExpDate;
                    ht[Out] = _ReceiveDoc.PropertyNames.Out;
                    ht[ReceivedStatus] = _ReceiveDoc.PropertyNames.ReceivedStatus;
                    ht[ReceivedBy] = _ReceiveDoc.PropertyNames.ReceivedBy;
                    ht[Remark] = _ReceiveDoc.PropertyNames.Remark;
                    ht[StoreID] = _ReceiveDoc.PropertyNames.StoreID;
                    ht[LocalBatchNo] = _ReceiveDoc.PropertyNames.LocalBatchNo;
                    ht[RefNo] = _ReceiveDoc.PropertyNames.RefNo;
                    ht[Cost] = _ReceiveDoc.PropertyNames.Cost;
                    ht[IsApproved] = _ReceiveDoc.PropertyNames.IsApproved;
                    ht[ManufacturerId] = _ReceiveDoc.PropertyNames.ManufacturerId;
        ...
        public class PropertyNames
        {
            ...
            static public string ToColumnName(string propertyName)
            {
                if (ht == null)
                {
                    ...
                    ht[ID] = _ReceiveDoc.ColumnNames.ID;
                    ht[BatchNo] = _ReceiveDoc.ColumnNames.BatchNo;
                    ht[ItemID] = _ReceiveDoc.ColumnNames.ItemID;
                    ht[SupplierID] = _ReceiveDoc.ColumnNames.SupplierID;
                    ht[Quantity] = _ReceiveDoc.ColumnNames.Quantity;
                    ht[Date] = _ReceiveDoc.ColumnNames.Date;
                    ht[ExpDate] = _ReceiveDoc.ColumnNames.ExpDate;
                    ht[Out] = _ReceiveDoc.ColumnNames.Out;
                    ht[ReceivedStatus] = _ReceiveDoc.ColumnNames.ReceivedStatus;
                    ht[ReceivedBy] = _ReceiveDoc.ColumnNames.ReceivedBy;
                    ht[Remark] = _ReceiveDoc.ColumnNames.Remark;
                    ht[StoreID] = _ReceiveDoc.ColumnNames.StoreID;
                    ht[LocalBatchNo] = _ReceiveDoc.ColumnNames.LocalBatchNo;
                    ht[RefNo] = _ReceiveDoc.ColumnNames.RefNo;
                    ht[Cost] = _ReceiveDoc.ColumnNames.Cost;
                    ht[IsApproved] = _ReceiveDoc.ColumnNames.IsApproved;
                    ht[ManufacturerId] = _ReceiveDoc.ColumnNames.ManufacturerId;
        ...
        public virtual string InternalDrugCode
        {
            get
            {
                return base.Getstring(ColumnNames.InternalDrugCode);
            }
            set
            {
        ...
        public virtual string s_SubProgramID
        {
            ...
            set
            {
                if (string.Empty == value)
                    ...
                    this.SubProgramID = base.SetintAsString(ColumnNames.SubProgramID, value);
            }
        }
        ...
        public virtual string s_InternalDrugCode
        {
            get
            {
                return this.IsColumnNull(ColumnNames.InternalDrugCode) ? string.Empty : base.GetstringAsString(ColumnNames.InternalDrugCode);
            }
            set
            {
                if (string.Empty == value)
        ...
        public class WhereClause
        {
            ...
            public class TearOffWhereParameter
            {
                ...
                public WhereParameter InternalDrugCode
                {
                    get
                    {
            ...
            public WhereParameter InternalDrugCode
            {
                get
                {
                    if (_InternalDrugCode_W == null)
                    {
                        _InternalDrugCode_W = TearOff.InternalDrugCode;
                    }
                    return _InternalDrugCode_W;
                }
            }
        ...
        public class AggregateClause
        {
            ...
            public class TearOffAggregateParameter
            {
                ...
                public AggregateParameter InternalDrugCode
                {
                    get
                    {
        ...
        protected override IDbCommand GetInsertCommand()
        {
            ...
            cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ReceiveDocInsert]";
        ...
        protected override IDbCommand GetUpdateCommand()
        {
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ReceiveDocUpdate]";
        ...
        protected override IDbCommand GetDeleteCommand()
        {
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_ReceiveDocDelete]";
